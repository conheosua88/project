...
<script>
        ...
        var danhsach = function(ten_tieude,page,limit){
            var url = 'admin/tintuc/search_category';
    ...
    var sua = function(id){
        $.get('/admin/tintuc/danhsach/'+id,function(rs){
            var data = JSON.parse(rs);     
            var id = data.data.id    
    ...
    var sua_modal = function(){
        var ten = $("#frmEdit [name=tenEdit]").val();
            ...
            $.ajax({
                ...
                type:'post',
                url:'{{  url("admin/tintuc/suadanhmuc") }}' +'/' + $('#btnSaveEdit').attr('danhmuc-id'),
                contentType: false,
                processData: false,
                data:form_data
                }).done(function(rs){
            ...
            if (result.value) {
                ...
                var form_data = new FormData();
                    ...
                    $.ajax({
                        ...
                        type:'post',
                        url:'{{ url("admin/tintuc/xoadanhmuc") }}' +'/' +id,
                        contentType: false,
                        processData: false,
                        data: form_data,
                    }).done(function(rs){
    ...
    $(document).ready(function() {
        ...
        $("#btnSave").on('click',function(){
            ...
            $.ajax({
                ...
                type:'post',
                url:'{{ url("admin/tintuc/themdanhmuc") }}',
                contentType: false,
                processData: false,
                data:form_data
                }).done(function(rs){
